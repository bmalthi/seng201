...
public class Game {
	...
	public static void main(String[] args ) {				
		...
		while (!shouldQuit) {
			int nextOption = whatNextLah(input);			
			switch(nextOption) {
			  case 1:
			    // code block
			    break;
		...
		//System.out.println("Things to sell:");
		//System.out.println(world1.getStore().getToSell());
		//System.out.println("Things to buy:");
		//System.out.println(world1.getStore().getToBuy());				
